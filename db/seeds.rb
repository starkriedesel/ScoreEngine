...
user_admin = User.create({username: 'admin', password: 'password', password_confirmation: 'password', user_type: User::ADMIN})
user_red = User.create({username: 'red', password: 'password', password_confirmation: 'password', user_type: User::RED_TEAM})
user_red_alpha = User.create({username: 'redAlpha', password: 'password', password_confirmation: 'password', user_type: User::RED_TEAM, team: team_alpha})
user_red_beta = User.create({username: 'redBeta', password: 'password', password_confirmation: 'password', user_type: User::RED_TEAM, team: team_beta})
